...
import com.marchelo.developerslite2.favorites.FavoritesActivity;
import com.marchelo.developerslite2.post_list.BookPostListFragment;
import com.marchelo.developerslite2.post_list.PostListFragment;
import com.marchelo.developerslite2.post_list.QuickReturnScrollListener;
import com.marchelo.developerslite2.network.ApiFactory;
import com.marchelo.developerslite2.network.Constants;
import com.marchelo.developerslite2.post_list.SearchPostsFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    @BindView(R2.id.toolbar_stub_home_icon)
    View mToolbarStubIcon;

    @BindView(R2.id.toolbar_title)
    TextView mTitle;

    @BindView(R2.id.toolbar_spinner)
    Spinner mToolbarSpinner;

    @BindView(R2.id.toolbar_search)
    View mSearchLayout;

    @BindView(R2.id.txt_toolbar_search)
    EditText mSearchView;

    @BindView(R2.id.icon_toolbar_search)
    ImageView mSearchViewIcon;

    @BindView(R2.id.btn_toolbar_search_clear)
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R2.id.navigation_item_last:
                openCategoryFragment(Category.LATEST);
                break;
            case R2.id.navigation_item_best:
                mToolbarSpinner.setVisibility(View.VISIBLE);
                openCategoryFragment(Category.BEST);
                break;
            case R2.id.navigation_item_hot:
                openCategoryFragment(Category.HOT);
                break;
            case R2.id.navigation_item_random:
                openCategoryFragment(Category.RANDOM);
                break;
            case R2.id.navigation_item_search:
                openSearchFragment();
                break;
            case R2.id.navigation_item_bookmarks:
                openBookmarksFragment();
                break;
            case R2.id.navigation_item_favorites:
                openFavoritesActivity();
                break;
            case R2.id.navigation_item_settings:
                openSettings();
                break;
        }
