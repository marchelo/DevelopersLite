package com.marchelo.developerslite2.db;
...
/**
 * This is a separate program from the actual android app,
...
public class OrmLiteDatabaseConfigUtil extends OrmLiteConfigUtil {
     ...
     */
    private static final Class<?>[] classes = new Class[] {Post.class, Favorite.class};
