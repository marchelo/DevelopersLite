...
import com.marchelo.developerslite2.view.DividerItemDecorator;
...
public class PostDetailsActivity extends AppCompatActivity {
    ...
    @BindView(R2.id.list_view_post_details)
...
//        ActivityCompat.startActivity(activity, intent, options.toBundle());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R2.id.details_menu_share_post_link:
                mHeaderViewHolder.sharePostLink();
                break;

            case R2.id.details_menu_share_post:
                mHeaderViewHolder.sharePost();
                break;

            case R2.id.details_menu_open_in_browser:
                mHeaderViewHolder.openInBrowser();
                break;

            case R2.id.details_menu_bookmark_post:
//                if (item.isChecked()) {
//                } else {
//                }
