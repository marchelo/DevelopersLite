...
import com.marchelo.developerslite2.details.APostViewHolder;
import com.marchelo.developerslite2.details.PostDetailsActivity;
...
import com.marchelo.developerslite2.utils.ViewsTintConfig;
import com.marchelo.developerslite2.model.Post;
import com.marchelo.developerslite2.utils.LoadGifImageReactor;
...
public class PostViewHolder extends APostViewHolder {
    ...
    @BindView(R2.id.btn_bookmark)
    protected CompoundButton bookmarkBtn;

    @BindView(R2.id.btn_share_post)
    protected ImageButton mSharePostBtn;

    @BindView(R2.id.btn_share_post_link)
    protected ImageButton mSharePostLinkBtn;

    @BindView(R2.id.btn_details)
    protected ImageButton mDetailsBtn;

    @BindColor(R2.color.colorPrimary) int mPrimaryColorValue;
    ...
    @OnClick(R2.id.btn_save_gif_link)
    protected void saveImageLink(View view) {
        view.setSelected(!view.isSelected());
    }

    @OnClick(R2.id.btn_details)
