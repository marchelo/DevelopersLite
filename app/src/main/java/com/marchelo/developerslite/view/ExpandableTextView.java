...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void toggle() {
        ...
        int destHeight;
        if (mCollapsed) {
            destHeight = mCollapsedHeight;
        } else {
            destHeight = getHeight() + mTextHeightWithMaxLines - mTv.getHeight();
        }

        mTv.setMaxHeight(destHeight - mMarginBetweenTxtAndBottom);
        getLayoutParams().height = destHeight;
        requestLayout();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mCollapsed) {
            ...
            Log.d(TAG, "onMeasure() mCollapsedHeight = " + mCollapsedHeight);
        }
    }
